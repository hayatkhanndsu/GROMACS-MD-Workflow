...
nx_major = int(nx.__version__.split('.')[0])
nx_minor = int(nx.__version__.split('.')[1])
...
if(nx_major < 2):
	...
	if(nx_major == 2 and nx_minor > 4):
		print("Warning: This script has been tested with NetworkX 2.3")
		print("Current version:", nx.__version__)
